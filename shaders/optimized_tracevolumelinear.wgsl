...
fn tint_symbol_99(tint_symbol_79_1 : vec2i, tint_symbol_23_7 : vec3f, tint_symbol_28_10 : vec3f) {
  ...
  let x_1762 = tint_symbol_80_1;
  textureStore(tint_symbol_73, tint_symbol_79_1, x_1762);
  return;
}

const x_1784 = vec2f(2.0f);
...
fn tint_symbol_108_inner(tint_symbol_109 : vec3u) {
  ...
  var x_1780 : bool;
  var x_1781 : bool;
  let x_1767 = bitcast<vec2i>(tint_symbol_109.xy);
  let x_1770 = bitcast<vec2i>(vec2i(textureDimensions(tint_symbol_73)));
  let x_1775 = (x_1767.x < x_1770.x);
  x_1781 = x_1775;
  if (x_1775) {
    x_1780 = (x_1767.y < x_1770.y);
    x_1781 = x_1780;
  }
  if (x_1781) {
    let x_1789 = (x_1784 / tint_symbol_70.inner.tint_symbol_66.xy);
    tint_symbol_37_1 = vec3f((((f32(x_1767.x) + 0.5f) * x_1789.x) - 1.0f), (((f32(x_1767.y) + 0.5f) * x_1789.y) - 1.0f), 0.0f);
    tint_symbol_112 = vec3f(0.0f, 0.0f, 1.0f);
    let x_1807 = tint_symbol_37_1;
    let x_1806 = tint_symbol_76(x_1807);
    tint_symbol_37_1 = x_1806;
    let x_1809 = tint_symbol_112;
    let x_1808 = tint_symbol_74(x_1809);
    tint_symbol_112 = x_1808;
    let x_1811 = tint_symbol_37_1;
    let x_1812 = tint_symbol_112;
    tint_symbol_99(x_1767, x_1811, x_1812);
  }
  return;
}

fn tint_symbol_108_1() {
  let x_1817 = tint_symbol_109_1;
  tint_symbol_108_inner(x_1817);
  return;
}
...
fn tint_symbol_113_inner(tint_symbol_109_3 : vec3u) {
  ...
  var x_1833 : bool;
  var x_1834 : bool;
  let x_1821 = bitcast<vec2i>(tint_symbol_109_3.xy);
  let x_1823 = bitcast<vec2i>(vec2i(textureDimensions(tint_symbol_73)));
  let x_1828 = (x_1821.x < x_1823.x);
  x_1834 = x_1828;
  if (x_1828) {
    x_1833 = (x_1821.y < x_1823.y);
    x_1834 = x_1833;
  }
  if (x_1834) {
    let x_1842 = ((x_1784 / tint_symbol_70.inner.tint_symbol_66) * tint_symbol_70.inner.tint_symbol_65);
    tint_symbol_37_2 = vec3f();
    tint_symbol_114 = vec3f((((f32(x_1821.x) + 0.5f) * x_1842.x) - tint_symbol_70.inner.tint_symbol_65.x), (((f32(x_1821.y) + 0.5f) * x_1842.y) - tint_symbol_70.inner.tint_symbol_65.y), 1.0f);
    tint_symbol_112_1 = normalize(tint_symbol_114);
    let x_1866 = tint_symbol_37_2;
    let x_1865 = tint_symbol_76(x_1866);
    tint_symbol_37_2 = x_1865;
    let x_1868 = tint_symbol_112_1;
    let x_1867 = tint_symbol_74(x_1868);
    tint_symbol_112_1 = x_1867;
    let x_1870 = tint_symbol_37_2;
    let x_1871 = tint_symbol_112_1;
    tint_symbol_99(x_1821, x_1870, x_1871);
  }
  return;
}

fn tint_symbol_113_1() {
  let x_1875 = tint_symbol_109_2;
  tint_symbol_113_inner(x_1875);
  return;
}

...
var<private> tint_symbol_66_1 : vec3u;

var<private> tint_symbol_66_2 : vec3u;
...
fn tint_symbol_56(tint_symbol_35_1 : vec2i, tint_symbol_46_3 : vec3f, tint_symbol_32_4 : vec3f) {
  ...
  if ((tint_symbol_57.x >= 0.0f)) {
    ...
    tint_symbol_59 = (tint_symbol_59 / (tint_symbol_57.y - tint_symbol_57.x));
    tint_symbol_36_1 = vec4f(tint_symbol_59, tint_symbol_59, tint_symbol_59, 1.0f);
  } else {
    tint_symbol_36_1 = x_242;
  }
  let x_665 = tint_symbol_36_1;
  textureStore(tint_symbol_30, tint_symbol_35_1, x_665);
  return;
}

const x_688 = vec2f(2.0f);

fn tint_symbol_65_inner(tint_symbol_66 : vec3u) {
  var tint_symbol_69 = vec3f();
  var tint_symbol_70 = vec3f();
  var x_683 : bool;
  var x_684 : bool;
  let x_670 = bitcast<vec2i>(tint_symbol_66.xy);
  let x_673 = bitcast<vec2i>(vec2i(textureDimensions(tint_symbol_30)));
  let x_678 = (x_670.x < x_673.x);
  x_684 = x_678;
  if (x_678) {
    x_683 = (x_670.y < x_673.y);
    x_684 = x_683;
  }
  if (x_684) {
    let x_693 = (x_688 / tint_symbol_27.inner.tint_symbol_26.xy);
    tint_symbol_69 = vec3f((((f32(x_670.x) + 0.5f) * x_693.x) - 1.0f), (((f32(x_670.y) + 0.5f) * x_693.y) - 1.0f), 0.0f);
    tint_symbol_70 = vec3f(0.0f, 0.0f, 1.0f);
    let x_711 = tint_symbol_69;
    let x_710 = tint_symbol_33(x_711);
    tint_symbol_69 = x_710;
    let x_713 = tint_symbol_70;
    let x_712 = tint_symbol_31(x_713);
    tint_symbol_70 = x_712;
    let x_715 = tint_symbol_69;
    let x_716 = tint_symbol_70;
    tint_symbol_56(x_670, x_715, x_716);
  }
  return;
}

fn tint_symbol_65_1() {
  let x_721 = tint_symbol_66_1;
  tint_symbol_65_inner(x_721);
  return;
}

@compute @workgroup_size(16i, 16i, 1i)
fn computeOrthogonalMain(@builtin(global_invocation_id) tint_symbol_66_1_param : vec3u) {
  tint_symbol_66_1 = tint_symbol_66_1_param;
  tint_symbol_65_1();
}

fn tint_symbol_71_inner(tint_symbol_66_3 : vec3u) {
  var tint_symbol_69_1 = vec3f();
  var tint_symbol_72 = vec3f();
  var tint_symbol_70_1 = vec3f();
  var x_737 : bool;
  var x_738 : bool;
  let x_725 = bitcast<vec2i>(tint_symbol_66_3.xy);
  let x_727 = bitcast<vec2i>(vec2i(textureDimensions(tint_symbol_30)));
  let x_732 = (x_725.x < x_727.x);
  x_738 = x_732;
  if (x_732) {
    x_737 = (x_725.y < x_727.y);
    x_738 = x_737;
  }
  if (x_738) {
    let x_746 = ((x_688 / tint_symbol_27.inner.tint_symbol_26) * tint_symbol_27.inner.tint_symbol_25);
    tint_symbol_69_1 = vec3f();
    tint_symbol_72 = vec3f((((f32(x_725.x) + 0.5f) * x_746.x) - tint_symbol_27.inner.tint_symbol_25.x), (((f32(x_725.y) + 0.5f) * x_746.y) - tint_symbol_27.inner.tint_symbol_25.y), 1.0f);
    tint_symbol_70_1 = normalize(tint_symbol_72);
    let x_770 = tint_symbol_69_1;
    let x_769 = tint_symbol_33(x_770);
    tint_symbol_69_1 = x_769;
    let x_772 = tint_symbol_70_1;
    let x_771 = tint_symbol_31(x_772);
    tint_symbol_70_1 = x_771;
    let x_774 = tint_symbol_69_1;
    let x_775 = tint_symbol_70_1;
    tint_symbol_56(x_725, x_774, x_775);
  }
  return;
}

fn tint_symbol_71_1() {
  let x_779 = tint_symbol_66_2;
  tint_symbol_71_inner(x_779);
  return;
}

@compute @workgroup_size(16i, 16i, 1i)
fn computeProjectiveMain(@builtin(global_invocation_id) tint_symbol_66_2_param : vec3u) {
  tint_symbol_66_2 = tint_symbol_66_2_param;
  tint_symbol_71_1();
}

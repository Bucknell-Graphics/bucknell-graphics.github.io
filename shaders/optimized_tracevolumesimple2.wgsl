...
fn tint_symbol_59_inner(tint_symbol_60 : vec3u) {
  ...
  if (x_514) {
    let x_523 = (x_518 / tint_symbol_27.inner.tint_symbol_26.xy);
...
fn tint_symbol_65_inner(tint_symbol_60_3 : vec3u) {
  var tint_symbol_63_1 = vec3f();
  var tint_symbol_66 = vec3f();
  var tint_symbol_64_1 = vec3f();
  var x_567 : bool;
  var x_568 : bool;
  let x_555 = bitcast<vec2i>(tint_symbol_60_3.xy);
  let x_557 = bitcast<vec2i>(vec2i(textureDimensions(tint_symbol_30)));
  let x_562 = (x_555.x < x_557.x);
  x_568 = x_562;
  if (x_562) {
    x_567 = (x_555.y < x_557.y);
    x_568 = x_567;
  }
  if (x_568) {
    let x_576 = ((x_518 / tint_symbol_27.inner.tint_symbol_26) * tint_symbol_27.inner.tint_symbol_25);
    tint_symbol_63_1 = vec3f();
    tint_symbol_66 = vec3f((((f32(x_555.x) + 0.5f) * x_576.x) - tint_symbol_27.inner.tint_symbol_25.x), (((f32(x_555.y) + 0.5f) * x_576.y) - tint_symbol_27.inner.tint_symbol_25.y), 1.0f);
    tint_symbol_64_1 = normalize(tint_symbol_66);
    let x_600 = tint_symbol_63_1;
    let x_599 = tint_symbol_33(x_600);
    tint_symbol_63_1 = x_599;
    let x_602 = tint_symbol_64_1;
    let x_601 = tint_symbol_31(x_602);
    tint_symbol_64_1 = x_601;
    let x_604 = tint_symbol_63_1;
    let x_605 = tint_symbol_64_1;
    tint_symbol_56(x_555, x_604, x_605);
  }
  return;
}

fn tint_symbol_65_1() {
  let x_609 = tint_symbol_60_2;
  tint_symbol_65_inner(x_609);
  return;
}

...
fn tint_symbol_107_inner(tint_symbol_103_3 : vec3u) {
  ...
  if (x_1664) {
    let x_1672 = ((x_1614 / tint_symbol_70.inner.tint_symbol_66) * tint_symbol_70.inner.tint_symbol_65);
    tint_symbol_37_2 = vec3f();
    tint_symbol_108 = vec3f((((f32(x_1651.x) + 0.5f) * x_1672.x) - tint_symbol_70.inner.tint_symbol_65.x), (((f32(x_1651.y) + 0.5f) * x_1672.y) - tint_symbol_70.inner.tint_symbol_65.y), 1.0f);
    tint_symbol_106_1 = normalize(tint_symbol_108);
    let x_1696 = tint_symbol_37_2;
    let x_1695 = tint_symbol_76(x_1696);
    tint_symbol_37_2 = x_1695;
    let x_1698 = tint_symbol_106_1;
    let x_1697 = tint_symbol_74(x_1698);
    tint_symbol_106_1 = x_1697;
    let x_1700 = tint_symbol_37_2;
    let x_1701 = tint_symbol_106_1;
    tint_symbol_99(x_1651, x_1700, x_1701);
  }
  return;
}

fn tint_symbol_107_1() {
  let x_1705 = tint_symbol_103_2;
  tint_symbol_107_inner(x_1705);
  return;
}
